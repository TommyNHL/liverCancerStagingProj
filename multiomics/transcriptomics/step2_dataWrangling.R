...
log2.cpm.df.pivot <- pivot_longer(
    ...
    cols = 'HepG2_control1':'HepG2_treat3_Diesel', # column names to be stored as a SINGLE variable
...
table(rowSums(myDGEList$counts==0)==3)
...
# save
write.csv(myDGEList@.Data[1], "../myDGEListDiesel.csv")
write.csv(log2.cpm.df, "../myDGEListDiesellog2.csv")

save(myDGEList.filtered, file = "../myDGEListDieselFilter")
write.csv(myDGEList.filtered@.Data[1], "../myDGEListDiesel_filtered.csv")
write.csv(log2.cpm.filtered.df, "../myDGEListDiesellog2_filtered.csv")

save(myDGEList.filtered.norm, file = "../myDGEListDieselFilterNorm")
write.csv(myDGEList.filtered.norm@.Data[1], "../myDGEListDiesel_filtered_normalized.csv")
write.csv(log2.cpm.filtered.norm.df, "../myDGEListDiesellog2_filtered_normalized.csv")
...
write.csv(cpm.filtered.norm.df, "../myDGEListDiesellog2FALSE_filtered_normalized.csv")
